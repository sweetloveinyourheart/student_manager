...
namespace Quản_lý_điểm_sinh_vien_CNTT
{
    public partial class frmQLDiemThiLai : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanlydiemDataSet42.tblKET_QUA2' table. You can move, or remove it, as needed.
            this.tblKET_QUA2TableAdapter.Fill(this.quanlydiemDataSet42.tblKET_QUA2);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (reader1.Read())
            {
                ...
                cmd1.Dispose();
                // Thực hiện truy vấn
                string insert = "Insert Into tblKET_QUA2(MaSV,HoTen,MaLop,TenMon,DiemThiLai,HocKi)" +
                "Values('" + txtMaSV.Text + "',N'" + txtHoTen.Text + "','" + cboLop.Text + "',N'" + cboMonHoc.Text + "','" +
                txtDiemThi2.Text + "','" + cboHocKi.Text + "')";
        ...
        {
            // Thực hiện truy vấn
            string select = "Select * From tblKET_QUA2  ";
            SqlCommand cmd = new SqlCommand(select, conn);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                string delete = "delete from tblKET_QUA2 where MaSV='" + txtMaSV.Text + "' and TenMon=N'" + cboMonHoc.Text + "' ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // Thực hiện truy vấn
                string update = "Update tblKET_QUA2 Set HoTen=N'" + txtHoTen.Text + "',TenMon=N'" +
                                cboMonHoc.Text + "',MaLop='" + cboLop.Text + "',DiemThiLai='" +
                                txtDiemThi2.Text + "',HocKi=N'" + cboHocKi.Text + "' where MaSV='" + txtMaSV.Text + "' and TenMon=N'" + cboMonHoc.Text + "'";
